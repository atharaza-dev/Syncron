...
export default function HomeScreen({ navigation }) {
  ...
  // Function to handle adding a new cashbook
  const handleAddCashbook = (cashbookData) => {
    console.log('New Cashbook:', cashbookData); // Replace with your logic to add cashbook
    // Example: Add to a list, make an API call, etc.
  };
    ...
    <View className="flex-1 bg-white">
      ...
      <View className="flex-1">
        ...
        <View style={{ position: 'relative' }}>
          <ImageBackground source={bg} style={{ height: 320 }} resizeMode="cover">
            ...
            <View className="mx-2 mb-4">
              ...
              <View className="bg-white border border-slate-200 shadow-lg rounded-lg p-5 relative overflow-hidden">
                ...
                <View className="flex-row items-center">
                  <TouchableOpacity
                    onPress={() => navigation.navigate('ExpenseBook')}
                    className="bg-[#2563eb] flex-row items-center justify-center flex-1 rounded p-2"
                  >
      ...
      <AddCashbookModal
        ...
        onAddCashbook={handleAddCashbook}
      />
    </View>
  );
}