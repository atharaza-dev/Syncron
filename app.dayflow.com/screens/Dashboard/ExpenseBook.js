        ...
        <View className="flex-1 bg-white">
            ...
            <View className="flex-1">
                ...
                <View style={{ height: 180 }}>
                    ...
                    {/* Balance Section */}
                    <View className="items-start px-8 pt-4">
                        <View className="flex-row items-center mb-2">
                            <Calendar size={20} color="black" />
                            <Text className="text-black text-base font-medium ml-2 font-JakartaBold">28/05/2025</Text>
                        </View>
                        <Text className="text-black text-2xl font-light tracking-wide mb-1 font-JakartaBold">
                            Cashbook Name
                        </Text>
